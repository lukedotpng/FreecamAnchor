...
This is FreecamAnchor, a mod for Hitman 3!
...
3. Run the game and once in the main menu, press the `~` key (`^` on QWERTZ layouts) and enable `FreecamAnchor` from the menu at the top of the screen (you may need to restart your game afterwards).
4. Enjoy!
